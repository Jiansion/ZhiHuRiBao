...
import com.qianjia.statuslayout.R;
 ...
 *         https://github.com/Todd-Davies/ProgressWheel/blob/master/src/com/todddavies/components/progressbar/ProgressWheel.java
 */
...
public class ProgressWheel extends View {
    ...
    private void parseAttributes(TypedArray a) {
        ...
        barSpinCycleTime = a.getInt(R.styleable.ProgressWheel_pwDelayMillis, (int) barSpinCycleTime);
