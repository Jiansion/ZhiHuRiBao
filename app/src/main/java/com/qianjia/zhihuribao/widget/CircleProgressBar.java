...
public class CircleProgressBar extends View {
    ...
    Property<CircleProgressBar, Float> numScaleProperty = new Property<CircleProgressBar, Float>(Float.class, "numberSize") {
        @Override
    ...
    Property<CircleProgressBar, Integer> numColorProperty = new Property<CircleProgressBar, Integer>(Integer.class, "numberColor") {
        @Override
        public Integer get(CircleProgressBar object) {
            return object.getNumberColor();
        }

        @Override
        public void set(CircleProgressBar object, Integer value) {
            object.setNumberColor(value);
        }
    };

    Property<CircleProgressBar, Integer> colorFulColorProperty = new Property<CircleProgressBar, Integer>(Integer.class, "reachedColor") {
        @Override
        public Integer get(CircleProgressBar object) {
    ...
    private void startNumAnimation() {
        ...
        numScaleAnimator.addUpdateListener(animation -> invalidate());
